...
"""
    ...
    Version 3 : 14/11/2020
        ...
        We’ll have to see if it can be done in one session – in the past, 
        we’ve had to split it up because it’s a long tour.

        Special effect requests….

        As far as moving around goes, 
        it’s another place where we want to avoid ladders and the elevator as much as we can 
        because they slow the tour down.

        I have a request that I haven’t made quite this way before. In the past, 
        I’ve asked to be taken up to the top of the mushroom stalk that the processing center 
        is inside for an overview of the Age. 
        That requires making a Jalak pillar platform. 
        I’d like to have that again, but this time I’d like to begin the tour up there 
        ...
        From there, it’s a warp up to the office at the top of the tower, 
        ...
        We’ll just walk into the pipe from there.

        We walk through the pipe, the prison cell, and out of the cave to the waterfall lagoon 
        and eventually to the harbor.

        As usual, I’d like to have a viewing platform above the stream down the mountain 
        so I can show that the “sun” disk is artificial and has a back side.

        Another spot I’d like to have a platform is above the eastern island that’s across 
        from the control tower. 
        We rarely go there.

        That’s all I can think of for now. 
        I’ll be supplementing the tour with still pictures on the stream.

        -----

        I forgot to ask about this, and we’re half a week out…
        ...
        We’ve never grabbed a buggaro before and just held it in one place for the guests to see, 
        and of course Shroomie is a must. 
        We’ve shown Shroomie before, but the other two are ones I never thought of showing off before.
